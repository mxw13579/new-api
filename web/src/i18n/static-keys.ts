...
export const STATIC_I18N_KEYS = [
  ...
  // Invoice status and stable error labels
  'Invoice submitted',
  'Invoice reviewing',
  'Invoice approved',
  'Invoice rejected',
  'Invoice cancelled',
  'Invoice issued',
  'Invoice fee not required',
  'Invoice fee paid',
  'Invoice fee refund pending',
  'Invoice fee refunded',
  'Invoice payment review clear',
  'Invoice payment review pre-issue hold',
  'Invoice payment review post-issue hold',
  'Invoice payment review resolved valid',
  'Invoice payment review resolved voided',
  'Invoice document uploading',
  'Invoice document validating',
  'Invoice document available',
  'Invoice document superseded',
  'Invoice document upload failed',
  'Invoice document deleting',
  'Invoice document deleted',
  'Invoice document delete failed',
  'Invoice document missing',
  'Invoice error: invalid request',
  'Invoice error: permission denied',
  'Invoice error: insufficient wallet quota',
  'Invoice error: not found',
  'Invoice error: duplicate request conflict',
  ...
  'Invoice error: document unavailable',
  'Invoice error: service unavailable',
