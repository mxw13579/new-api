...
import { loadUserForDrawer } from '../lib/frontend-gates'
  ...
  useEffect(() => {
    ...
    if (open && isUpdate && currentRow) {
      void loadUserForDrawer(
        ...
        (user) => form.reset(transformUserToFormDefaults(user)),
        (error) => handleServerError(error, t('Failed to load')),
        () => current
      )
