...
if (!isolatedRun) {
  describe('API key group table cell isolation', () => {
    test('verifies the cell contracts in a disposable Bun process', () => {
      const child = spawnSync(
        process.execPath,
        [
          'test',
          'src/features/keys/components/__tests__/api-key-group-cell.test.tsx',
        ],
        {
          cwd: process.cwd(),
