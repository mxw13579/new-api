...
export function FetchModelsDialog({
  ...
  const activeChannelId = resolveFetchChannelId(
    Boolean(customFetcher),
    currentRow
  )
  ...
  const contentState = getFetchModelsContentState(
  ...
  const defaultTab = getFetchModelsDefaultTab(
    newModels.length,
    removedModels.length
  )
