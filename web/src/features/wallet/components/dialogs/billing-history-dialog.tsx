...
import { InvoiceFeeHistoryPanel } from './invoice-fee-history-panel'
...
export function BillingHistoryDialog({
  ...
  const [activeTab, setActiveTab] = useState<'topups' | 'invoice-fees'>(
    'topups'
  )
    ...
    <>
      ...
      >
        <Tabs
          value={activeTab}
          onValueChange={(value) =>
            setActiveTab(value as 'topups' | 'invoice-fees')
          }
        >
          <TabsList>
            <TabsTrigger value='topups'>{t('Top-up history')}</TabsTrigger>
            <TabsTrigger value='invoice-fees'>{t('Invoice fees')}</TabsTrigger>
          </TabsList>
          <TabsContent value='topups' className='min-h-0 space-y-3'>
          ...
          <TabsContent value='invoice-fees'>
            <InvoiceFeeHistoryPanel
              enabled={open && activeTab === 'invoice-fees'}
            />
          </TabsContent>
        </Tabs>
      </Dialog>
