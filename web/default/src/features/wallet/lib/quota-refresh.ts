...
type RefreshWalletData = () => Promise<void> | void

export async function refreshWalletAfterConfirmedQuotaChange(
...
export async function refreshWalletAfterOrderCreation(
  refreshWalletData: RefreshWalletData
): Promise<void> {
  await refreshWalletData()
}
