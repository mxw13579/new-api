...
func InitOptionMap() {
	...
	common.OptionMap["RechargeRebateRatioForInviter"] = strconv.FormatFloat(common.RechargeRebateRatioForInviter, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RechargeRebateRatioForInviter":
		common.RechargeRebateRatioForInviter, _ = strconv.ParseFloat(value, 64)
